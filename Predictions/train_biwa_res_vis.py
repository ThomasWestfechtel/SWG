...
import network_mp_res101_adam as network
import loss
...
def train(config):
    ...
    if(args.dset == 'office-home'):
        if(args.pretext == 0):
            preds_source = np.load("Predictions_res_oh/" + args.s + ".npy")
            preds_target = np.load("Predictions_res_oh/" + args.t + ".npy")
        if(args.pretext == 1):
            preds_source = np.load("Predictions_res_oh/" + args.s + "_Cifar.npy")
            preds_target = np.load("Predictions_res_oh/" + args.t + "_Cifar.npy")
        elif(args.pretext == 2):
            preds_source = np.load("Predictions_res_oh/" + args.s + "_ImageNet.npy")
            preds_target = np.load("Predictions_res_oh/" + args.t + "_ImageNet.npy")
        elif(args.pretext == 3):
            preds_source = np.load("Predictions_res_oh/" + args.s + "_ImageNetSm.npy")
            preds_target = np.load("Predictions_res_oh/" + args.t + "_ImageNetSm.npy")
    elif(args.dset == 'office'):
        if(args.pretext == 0):
            preds_source = np.load("Predictions_res_o31/" + args.s + ".npy")
            preds_target = np.load("Predictions_res_o31/" + args.t + ".npy")
        if(args.pretext == 1):
            preds_source = np.load("Predictions_res_o31/" + args.s + "_Cifar.npy")
            preds_target = np.load("Predictions_res_o31/" + args.t + "_Cifar.npy")
        elif(args.pretext == 2):
            preds_source = np.load("Predictions_res_o31/" + args.s + "_ImageNet.npy")
            preds_target = np.load("Predictions_res_o31/" + args.t + "_ImageNet.npy")
        elif(args.pretext == 3):
            preds_source = np.load("Predictions_res_o31/" + args.s + "_ImageNetSm.npy")
            preds_target = np.load("Predictions_res_o31/" + args.t + "_ImageNetSm.npy")
    elif(args.dset == 'visda'):
        if(args.pretext == 0):
            preds_source = np.load("Predictions_res_vis/" + args.s + ".npy")
            preds_target = np.load("Predictions_res_vis/" + args.t + ".npy")
        if(args.pretext == 1):
            preds_source = np.load("Predictions_res_vis/" + args.s + "_Cifar.npy")
            preds_target = np.load("Predictions_res_vis/" + args.t + "_Cifar.npy")
        elif(args.pretext == 2):
            preds_source = np.load("Predictions_res_vis/" + args.s + "_ImageNet.npy")
            preds_target = np.load("Predictions_res_vis/" + args.t + "_ImageNet.npy")
        elif(args.pretext == 3):
            preds_source = np.load("Predictions_res_vis/" + args.s + "_ImageNetSm.npy")
            preds_target = np.load("Predictions_res_vis/" + args.t + "_ImageNetSm.npy")
        elif(args.pretext == 4):
            preds_source = np.load("Pred-res/" + args.s + "_"+str(args.seed)+".npy")
            preds_target = np.load("Pred-res/" + args.t + "_"+str(args.seed)+".npy")
        elif(args.pretext == 5):
            preds_source = np.load("ZS_Preds/Predictions_res_VS/" + args.s + "_3_1.npy")
            preds_target = np.load("ZS_Preds/Predictions_res_VS/" + args.t + "_3_1.npy")
