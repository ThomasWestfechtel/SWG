...
def train(config):
    ...
    if(args.dset == 'office-home'):
        if(args.pretext == 0):
            preds_source = np.load("Predictions/OH/ViT/" + args.s + "_3_1.npy")
            preds_target = np.load("Predictions/OH/ViT/" + args.t + "_3_1.npy")
        elif(args.pretext == 1):
            preds_source = np.load("Predictions/DAPL/OH/ViT/" + args.s.lower()[0] + "2" + args.t.lower()[0] + "_source_" + str(args.seed) + ".npy")
            preds_target = np.load("Predictions/DAPL/OH/ViT/" + args.s.lower()[0] + "2" + args.t.lower()[0] + "_target_" + str(args.seed) + ".npy")
    elif(args.dset == 'visda'):
        if(args.pretext == 0):
            preds_source = np.load("Predictions/VS/ViT/" + args.s + "_3_1.npy")
            preds_target = np.load("Predictions/VS/ViT/" + args.t + "_3_1.npy")
        elif(args.pretext == 1):
            preds_source = np.load("Predictions/DAPL/VS/ViT/" + args.s + "_"+str(args.seed)+".npy")
            preds_target = np.load("Predictions/DAPL/VS/ViT/" + args.t + "_"+str(args.seed)+".npy")
    elif (args.dset == 'domain-net'):
        if(args.pretext == 0):
            preds_source = np.load("Predictions/DN/ViT/" + args.s + "_3_1.npy")
            preds_target = np.load("Predictions/DN/ViT/" + args.t + "_3_1.npy")
